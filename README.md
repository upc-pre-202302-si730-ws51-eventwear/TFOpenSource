...
Capítulo I: Introducción **(Jeremy Quispe)**
1\.1. Startup Profile
...
Entrevista 3: <https://youtu.be/0C65w_FMg4U>
...
<table><tr><th rowspan="2" valign="top"><p></p><p>Actividades</p></th><th colspan="2" valign="top">Leticia Cassanova</th></tr>
...
Capítulo III: Requirements Specification. **(Jair Castillo)**

**3.1. To-Be Scenario Mapping -  Segmento objetivo #1: Desarrolladores en búsqueda de empleo** 

![](Aspose.Words.dd8df8e0-88aa-418a-a3ac-8af5e76e04e2.012.jpeg)
...
![](Aspose.Words.dd8df8e0-88aa-418a-a3ac-8af5e76e04e2.013.jpeg)
...
Representación Visual de Servicios: Imágenes que simbolizan cada uno de los servicios principales, ayudando a la identificación rápida por parte del usuario.
...
**\*\*Intercambio de prendas:\*\* Una sección dedicada a facilitar el intercambio de prendas entre usuarios, promoviendo así la reutilización y reduciendo el desperdicio de moda.**
...
Búsqueda de empleados: El sistema de búsqueda también estará presente en la visualización de empleados.

Al implementar estos sistemas de búsqueda, los usuarios podrán encontrar fácil y rápidamente la información que necesitan dentro de la aplicación "Getwork". Esto les ayudará a gestionar y realizar un seguimiento eficaz de sus contrataciones y a tomar decisiones informadas basadas en los datos proporcionados.


**4.2.5. Navigation Systems.**

Los principales sistemas de navegación en Getwork son los menús superior e inferior. Estas etiquetas ayudan a los usuarios a navegar por las secciones que desean ver dentro de la página. Si no se utilizan enlaces, el usuario verá la página en orden descendente. En la aplicación, los usuarios navegan por los recursos y la formación que ofrece Getwork para prepararse para entrevistas técnicas en empresas de tecnología. Los botones también representan la apertura, confirmación o finalización de un registro y permiten a los usuarios seguir el proceso en una nueva pantalla.
...
![](Aspose.Words.dd8df8e0-88aa-418a-a3ac-8af5e76e04e2.029.png)
...
![](Aspose.Words.dd8df8e0-88aa-418a-a3ac-8af5e76e04e2.030.png)

Capítulo V: Product Implementation, Validation & Deployment. **(Sebastian Cachis, Adriano Cruz)**
...
![](Aspose.Words.dd8df8e0-88aa-418a-a3ac-8af5e76e04e2.031.png)
...
<https://trello.com/invite/b/LttsMJKr/ATTI94f55e5f0ba61aa13fdfa922ffa3576019497B74/sprint-1> 

![](Aspose.Words.dd8df8e0-88aa-418a-a3ac-8af5e76e04e2.032.png)
...
|US01|Registro en la aplicación|T001|Implementar pantalla de registro|Implementar pantalla de registro con campos de nombre, correo electrónico y contraseña.|1|Jeremy|Done|
|US02|Seguridad de cuenta|T002|` `Configurar sistema de autenticación|Configurar sistema de autenticación de dos factores para la seguridad de la cuenta.|2|Sebastian|To review|
|US03|Realizar reserva|T003|Desarrollar la funcionalidad para buscar |Desarrollar la funcionalidad para buscar disponibilidad y realizar una reserva.|5|` `Adriano|Done|
|US04|Métodos de Pago|T004|Integrar diferentes métodos de pago|Integrar diferentes métodos de pago, como tarjetas de crédito y PayPal.|3|Alexander|To review|
|US05|Visualización de calendario de entrevistas y anotaciones|T005|Diseñar y programar la interfaz de usuario para visualizar el calendario|` `Diseñar y programar la interfaz de usuario para visualizar el calendario de entrevistas y anotaciones.|2|` `Andrea|Done|
|US06|Medio de comunicación|T006|Implementar un sistema de mensajería interna |` `Implementar un sistema de mensajería interna para permitir la comunicación entre usuarios.|3|Elias|To review|
|US07|Interfaz sencilla|T007|Diseñar y desarrollar una interfaz de usuario intuitiva|Diseñar y desarrollar una interfaz de usuario intuitiva y fácil de usar.|4|Sebastian|In process|
|US08|Participación en GetWork Contest|T008|Organizar y promover la participación en concursos|Organizar y promover la participación en concursos de GetWork para los usuarios.|1|Adriano|In process|
|US09|Variedad de idiomas|T009|Agregar soporte multilingüe|Agregar soporte multilingüe a la aplicación.|2|Jeremy|In process|
|US10|Agregar sugerencias y/o comentarios|T010|Implementar un sistema para que los usuarios puedan enviar sugerencia|` `Implementar un sistema para que los usuarios puedan enviar sugerencias y comentarios.|3|Alexander|In process|
|US11|Entrenamiento especializado en desarrollo de algoritmos|T011|Desarrollar un módulo de entrenamiento|` `Desarrollar un módulo de entrenamiento específico para algoritmos|5|Andrea|To review|
|US12|Práctica de simulacros de entrevistas técnicas|T012|Crear simulacros de entrevistas técnicas |Crear simulacros de entrevistas técnicas con preguntas relacionadas con el diseño de sistemas.|3|Elias|To review|
|US13|Recursos de preparación para entrevistas de diseño de sistemas|T013|Crear una sección de la aplicación |Crear una sección de la aplicación que incluya artículos, videos y ejercicios relacionados con la preparación para entrevistas de diseño de sistemas.|2|Sebastian|To review|
|US14|Entrenamiento en resolución de problemas de lógica|T014|` `Diseñar y programar ejercicios de lógica|` `Diseñar y programar ejercicios de lógica para el entrenamiento de los usuarios.|1|Adriano|To review|
|US15|Acceso a tutores especializados|T015|Configurar acceso a tutores|Configurar acceso a tutores expertos en diferentes campos.|5|Jeremy|To review|
|US16|Planificación de estudio personalizado|T016|Desarrollar un sistema para generar planes de estudio |Desarrollar un sistema para generar planes de estudio personalizados para los usuarios.|1|Andrea|To review|
|US17|Visualización de datos de usuario|T017|Desarrollar un panel de control |Desarrollar un panel de control para que los usuarios puedan ver y gestionar sus datos personales.|5|Elias|In process|
|US18|Simulacros de entrevistas en grupo|T018|Crear escenarios y pregunt|Crear escenarios y preguntas para simulacros de entrevistas en grupo.|3|Sebastian|To review|
|US19|Tutorías personalizadas con expertos|T019|Organizar sesiones de tutoría |Organizar sesiones de tutoría personalizadas con expertos.|3|Elias|To review|
|US20|Asesoramiento profesional y de carrera|T020|Ofrecer asesoramiento profesional|Ofrecer asesoramiento profesional y de carrera a los usuarios.|2|Alexander|To review|
|US21|Recursos de desarrollo de habilidades blandas|T021|Desarrollar recursos de aprendizaje|Desarrollar recursos de aprendizaje para habilidades blandas.|1|Adriano|To review|
|US22|Entrenamiento en resolución de problemas de codificación en tiempo real|T022|` `Implementar un entorno de codificación |Implementar un entorno de codificación en tiempo real para resolver problemas.|2|Jeremy|To review|
|US23|Biblioteca de preguntas frecuentes de entrevistas|T023|Crear una biblioteca de |Crear una biblioteca de preguntas frecuentes relacionadas con entrevistas.|2|Alexander|In process|
|US24|Simulacros de entrevistas técnicas en diferentes formatos|T024|` `Desarrollar simulacros de entrevistas|Desarrollar simulacros de entrevistas técnicas en diferentes formatos (por ejemplo, escritas, orales).|1|Andrea|To review|
|US25|Plataforma de práctica de diseño de sistemas|T025|Configurar una plataforma|Configurar una plataforma de práctica para el diseño de sistemas.|5|Elias|In process|
|US26|Entrevistas técnicas en vivo con expertos|T026|Organizar y programar entrevistas|Organizar y programar entrevistas técnicas en vivo con expertos.|2|Sebastian|In process|
|US27|Preparación para entrevistas técnicas específicas de la industria|T027|Desarrollar materiales de preparación |Desarrollar materiales de preparación para entrevistas técnicas específicas de la industria.|6|Adriano|To review|
|US28|Entrenamiento en resolución de problemas de optimización|T028|` `Crear ejercicios de resolución |Crear ejercicios de resolución de problemas de optimización.|1|Jeremy|To review|
|US29|Preparación para entrevistas técnicas de desarrollo web|T029|Preparar recursos|Preparar recursos para entrevistas técnicas de desarrollo web.|2|Alexander|To review|
|US30|Evaluación de habilidades antes de la preparación|T030|Desarrollar un sistema para evaluar las habilidades|Desarrollar un sistema para evaluar las habilidades de los usuarios antes de la preparación.|3|Andrea|In process|
